...
RUN ROOTFS=$(curl -sfOJL -w "amzn2-container-raw-2.0.20230221.0-x86_64.tar.xz" "https://amazon-linux-docker-sources.s3.amazonaws.com/amzn2/2.0.20230221.0/amzn2-container-raw-2.0.20230221.0-x86_64.tar.xz") \
